...
module.exports = function(sailsAppPath) {
  ...
  fns.ng2html = function(path, options) {
    var engine = requires.ng2html || (requires.ng2html = require(sailsAppPath + '/angular2-universal-preview'));
    
    // var layout = sails.config.views.layout;
    // var file = layout + '.' + sails.config.views.engine.ext;
    // var path = sails.config.paths.views + '/' + layout;
    ...
    engine.ng2engine(path, {App: App}, function(layout, file, path){
      return;
    });
  };
